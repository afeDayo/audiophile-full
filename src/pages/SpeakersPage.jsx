        ...
        >
          ...
          <div className="w-full lg:w-[54%] bg-[#F1F1F1] rounded-lg h-[352px] md:h-[450px] lg:h-[560px] flex items-center justify-center relative">
            <img
              src={product.image}
              alt={product.name}
              className="w-[180px] md:w-[202.2px] object-contain lg:w-[280px]"
            />
          ...
          <div className="w-full lg:w-[45%] xl:w-[445px] text-center lg:text-start flex flex-col gap-4 md:gap-[29px]">
            ...
            <h1 className="font-bold text-[28px] md:text-[40px] md:px-60 lg:text-4xl xl:text-[40px] leading-tight md:leading-11 tracking-[0.5px] md:tracking-[2px] uppercase text-[#000000] px-20 lg:px-0">
              {product.name}
            </h1>
